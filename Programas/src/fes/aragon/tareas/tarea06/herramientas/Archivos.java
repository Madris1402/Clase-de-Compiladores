package fes.aragon.tareas.tarea06.herramientas;
...
import fes.aragon.profe.cadenasTexto.Herramienta;
import fes.aragon.profe.cadenasTexto.Lexico;
...
//				}
	...
	public void analizarPalabras() {
		String nombreArchivoM = System.getProperty("user.dir") + "\\files\\matriz";
		String nombreArchivo = System.getProperty("user.dir") + "\\files\\palabras.txt";
