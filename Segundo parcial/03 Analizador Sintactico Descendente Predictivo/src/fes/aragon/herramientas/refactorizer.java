...
public class refactorizer {
    ...
    public static void refactorizer() throws IOException {
        ...
        String archivoSalida = System.getProperty("user.dir") + File.separator + "src" + File.separator + "fes" + File.separator + "aragon" + File.separator + "compilador" + File.separator +  "fuente.ref";
